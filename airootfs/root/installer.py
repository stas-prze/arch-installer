...
if is_efi():
    run("pacstrap /mnt base base-devel linux linux-lts alsa-utils grub efibootmgr python python-pip wireless_tools wpa_supplicant dialog net-tools")
else:
    run("pacstrap /mnt base base-devel linux linux-lts alsa-utils grub python python-pip wpa_supplicant dialog wireless_tools net-tools")
